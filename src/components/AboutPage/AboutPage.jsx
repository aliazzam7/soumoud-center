...
const team = [
  ...
  },
  {
    ...
    color: "#111111",
    qualifications: [
      { icon: <FaGraduationCap />, label: "Academic", items: ["Bachelor's in Arabic Language & Literature", "Lebanese University", "Pursuing Master's Degree in Arabic"] },
...
const values = [
  ...
  { icon: <FaUsers />, title: "Community", desc: "We are a trusted partner in the Borj Rahal community since 2018." },
];
    ...
    <section className="ab-hero">
      <div className="ab-hero__inner">
        ...
        <h1 className="ab-hero__h1">
          The Story Behind <span className="ab-yellow">Soumoud</span>
        </h1>
        <div className="ab-accent-line ab-accent-line--center" />
        <p className="ab-hero__sub">
          An educational center born from a passion for teaching and a belief that
          every student deserves the right environment to thrive.
        </p>
      ...
      <div className={`ab-story__inner ab-fade${inView ? " ab-fade--in" : ""}`}>
        <div className="ab-story__img-col">
          <div className="ab-story__imgbox">
            <img src="/center.jpg" alt="Soumoud Center" className="ab-story__img" />
            <div className="ab-story__imgfallback">
        ...
        <div className="ab-story__content">
          ...
          <h2 className="ab-h2">
            Built on the Belief That <span className="ab-yellow">Education Changes Everything</span>
          </h2>
          <div className="ab-accent-line" />
          <p className="ab-body">
            Soumoud Educational Center is an educational and developmental center established
            in Borj Rahal with the belief that education is the foundation for building a
            brighter future. The center aims to provide a supportive learning environment
            that helps students strengthen their academic abilities, develop their personal
            skills, and achieve success with confidence and excellence.
          </p>
          <p className="ab-body">
            The name <strong>"Soumoud"</strong> — meaning <em>resilience</em> — reflects our
            belief that education is the strongest path to resilience, hope, and growth. We
            remain steadfast despite challenges, empowering a generation of knowledgeable,
            confident, and responsible students capable of shaping a better future for their
            community and country.
          </p>
          <p className="ab-body">
            At Soumoud, we believe that every student has the potential to succeed when provided
            with the right guidance, encouragement, and learning environment. Our commitment
            is to support every learner and become a trusted partner in building a brighter future.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className={`ab-vision__inner ab-fade${inView ? " ab-fade--in" : ""}`}>
        ...
        <div className="ab-vision__cards">
          <div className="ab-vision__card ab-vision__card--vision">
            ...
            <p>
              We envision a community where every young person — regardless of background or
              starting point — has access to quality education that unlocks their full potential
              and prepares them to lead with knowledge, character, and confidence.
            </p>
          </div>
          <div className="ab-vision__card ab-vision__card--mission">
            ...
            <p>
              Our mission is to remain steadfast alongside our students — providing personalized
              academic support, a nurturing environment, and the tools each child needs to grow
    ...
    <section className="ab-offer" ref={ref}>
      <div className={`ab-offer__inner ab-fade${inView ? " ab-fade--in" : ""}`}>
        ...
        <ul className="ab-offer__list">
          {offers.map((item, i) => (
            <li key={i} className="ab-offer__item" style={{ animationDelay: `${i * 0.08}s` }}>
      ...
      <div className={`ab-team__inner ab-fade${inView ? " ab-fade--in" : ""}`}>
        <div className="ab-section-head">
          ...
          <p className="ab-section-sub">
            Two passionate educators who built Soumoud from the ground up — driven by love
            for teaching and commitment to their community.
          </p>
        </div>
    ...
    <section className="ab-cta" ref={ref}>
      <div className={`ab-cta__inner ab-fade${inView ? " ab-fade--in" : ""}`}>
        ...
        <p className="ab-cta__sub">
          Register your child today and give them the environment they deserve to grow,
          learn, and succeed.
        </p>
        <div className="ab-cta__btns">
          ...
          <a href="https://wa.me/96171240366" target="_blank" rel="noopener noreferrer" className="ab-cta__btn-wa">
            <FaWhatsapp /> WhatsApp Us
          </a>
          <a href="https://www.instagram.com/soumoud.center" target="_blank" rel="noopener noreferrer" className="ab-cta__btn-ig">
